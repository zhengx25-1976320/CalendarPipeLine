...
#     print(tagged_words)
    ...
    while i < length-1:
        ...
        if tagged_words[i][1] in noun_set and tagged_words[i+1][1] in noun_set and tagged_words[i+2][1] in noun_set: #noun + noun + noun
...
# print(extract_datetime('schedule meeting for one hour on Tuesday 4 p.m.'))
...
#     print(tagged_words)
    ...
    if res == '':
        print('return geograohic info of user\'s device')
...
#print(extract_location('have breakfast at Cafe on the Ave'))
...
#get_duration_number('meet with John at restaurant')
